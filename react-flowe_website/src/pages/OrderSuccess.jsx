...
export default function OrderSuccess() {
  ...
  return (
    <div className="min-h-screen bg-[#fdf6f0] font-[Jost] flex items-center justify-center">
      <div className="text-center px-8 max-w-md">
        <CheckCircle size={56} strokeWidth={1} className="text-[#c4957a] mx-auto mb-6" />

        <h1 className="font-[Cormorant_Garamond] text-4xl text-[#5c3d35] mb-3">
          Order Placed! 🌸
        </h1>
        ...
        <p className="text-[12px] text-[#b09088] mb-1">
          Payment ID: <span className="text-[#c4957a]">{state?.paymentId}</span>
        </p>
