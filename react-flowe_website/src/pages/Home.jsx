...
export default function Home() {
  return (
    <main>
      ...
      {/* Best Sellers */}
      <section className="bg-[#fdf6f0] py-12 md:py-20 px-4 md:px-10">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10">
            ...
            <h2 className="font-serif text-[32px] md:text-[42px] font-normal text-[#5c3d35] leading-tight">
          ...
          <div className="text-center mt-10">
            <Link to="/shop" className="text-xs tracking-[0.16em] uppercase text-[#8b5e52]
              border border-[#c4957a] hover:bg-[#c4957a] hover:text-white
              px-10 py-3.5 rounded-sm transition-all duration-200 font-medium inline-block">
              View All Flowers
            </Link>
          </div>
        </div>
      ...
      {/* Why Choose Us */}
      <section className="bg-[#f0e0d6] py-12 md:py-16 px-4 md:px-10">
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
          {[
            ...
            <div key={title} className="text-center">
              ...
              <h3 className="font-serif text-[15px] md:text-[18px] font-normal text-[#5c3d35] mb-2">{title}</h3>
      ...
      <section className="bg-[#fdf6f0] py-12 md:py-20 px-4 md:px-10">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-10">
            ...
            <h2 className="font-serif text-[32px] md:text-[42px] font-normal text-[#5c3d35]">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={label}
                className="rounded-md p-6 md:p-8 text-center cursor-pointer
                  hover:-translate-y-1 hover:shadow-md transition-all duration-200"
                style={{ background: bg }}>
                <div className="text-2xl md:text-3xl mb-3">{emoji}</div>
                <h4 className="font-serif text-[15px] md:text-[18px] text-[#5c3d35]">{label}</h4>
      ...
      {/* Testimonial */}
      <section className="bg-[#5c3d35] py-16 md:py-20 px-4 md:px-10 text-center">
        <div className="max-w-2xl mx-auto">
          <p className="text-[#c4957a] text-3xl mb-6">❝</p>
          <p className="font-serif text-[20px] md:text-[24px] font-light italic text-[#f5e6de] leading-relaxed mb-8">
