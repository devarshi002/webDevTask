...
export default function CartDrawer({ isOpen, onClose }) {
  ...
  return (
    <>
      ...
      {/* Drawer */}
      <div className={`fixed top-0 right-0 h-full w-[400px] bg-[#fdf6f0] z-50 shadow-2xl
        ...
        {cartItems.length === 0 ? (
          ...
          <>
            ...
            <div className="flex-1 overflow-y-auto px-6 py-4 flex flex-col gap-4">
              {cartItems.map(item => (
                <div key={item.id}
                  ...
                  <div className="w-[64px] h-[64px] rounded-sm shrink-0"
                  ...
                  <div className="flex flex-col items-end justify-between shrink-0">
                    ...
                    <div className="flex items-center gap-2 border border-[#e8d5c4]
            ...
            <div className="px-6 py-5 border-t border-[#e8d5c4] bg-white">
              ...
              {/* Checkout */}
              <button className="w-full text-xs tracking-widest uppercase text-white
